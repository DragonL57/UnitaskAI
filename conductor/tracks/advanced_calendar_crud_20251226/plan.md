# Plan: Advanced Calendar CRUD Operations
...
- [ ] Task: Refine `src/prompts/scheduler.ts` to improve event discovery and ID-based operations
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Agent Refinement' (Protocol in workflow.md)
